...
var frontpage = [
	...
	"欢迎来到ddddchat",
	"ddddchat，简称dchat、dc，是dddd借用部分（99.9%还好意思说部分az）hack.chat的源码搭建的",
	"这里的公共频道: https://ddddawa.github.com/ddddchat/?awaroom",
	"频道列表",
	"?lounge",
	"?114514",
	"?programming",
	"?games ",
	"?banana",
	"随机分配给你的频道: ?" + Math.random().toString(36).substr(2, 8),
	"",
	"向hack.chat致谢！",
	"https://github.com/hack-chat",
	"hack.chat项目仓库",
	"links:",
	"dddd博客: https://blog.hellobym.repl.co/和https://ddddawa.github.io/",
	"dddd邮箱: bym_ghost@outlook.com",
	"paperee的主页: https://paperee.guru/",
	"小张的博客: https://mrzhang365.github.io/",
	"小张GitHub: https://github.com/MrZhang365",
	"hcwiki: https://hcwiki.github.io/",
